...
import com.francisco.cursomc.domain.ItemPedido;
import com.francisco.cursomc.domain.Pagamento;
import com.francisco.cursomc.domain.PagamentoComBoleto;
import com.francisco.cursomc.domain.PagamentoComCartao;
import com.francisco.cursomc.domain.Pedido;
import com.francisco.cursomc.domain.Produto;
import com.francisco.cursomc.domain.enums.EstadoPagamento;
import com.francisco.cursomc.domain.enums.Perfil;
import com.francisco.cursomc.domain.enums.TipoCliente;
...
import com.francisco.cursomc.repositories.ItemPedidoRepository;
import com.francisco.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "franciscolopesdacunha@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "franciscolopes@edu.uniube.br", "31628382740", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
